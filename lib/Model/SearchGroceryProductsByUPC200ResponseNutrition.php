...
/**
 * SearchGroceryProductsByUPC200ResponseNutrition Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SearchGroceryProductsByUPC200ResponseNutrition implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'searchGroceryProductsByUPC_200_response_nutrition';
    ...
    public function setNutrients($nutrients)
    {
        ...
        if ((count($nutrients) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nutrients when calling SearchGroceryProductsByUPC200ResponseNutrition., number of items must be greater than or equal to 0.');
        }
