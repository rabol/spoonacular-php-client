...
/**
 * GetMealPlanWeek200ResponseDaysInnerItemsInnerValue Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetMealPlanWeek200ResponseDaysInnerItemsInnerValue implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getMealPlanWeek_200_response_days_inner_items_inner_value';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling GetMealPlanWeek200ResponseDaysInnerItemsInnerValue., must be bigger than or equal to 1.');
        }
