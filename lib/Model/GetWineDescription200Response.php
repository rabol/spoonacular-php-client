...
/**
 * GetWineDescription200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class GetWineDescription200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getWineDescription_200_response';
    ...
    {
        $this->setIfExists('wine_description', $data ?? [], null);
    }
    ...
    {
        if (is_null($wine_description)) {
            throw new \InvalidArgumentException('non-nullable wine_description cannot be null');
        }

        if ((mb_strlen($wine_description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $wine_description when calling GetWineDescription200Response., must be bigger than or equal to 1.');
        }
