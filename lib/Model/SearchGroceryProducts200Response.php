...
/**
 * SearchGroceryProducts200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class SearchGroceryProducts200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'searchGroceryProducts_200_response';
    ...
    protected static $openAPITypes = [
        'products' => '\OpenAPI\Client\Model\AutocompleteRecipeSearch200ResponseInner[]',
        'total_products' => 'int',
        'type' => 'string',
        'offset' => 'int',
        'number' => 'int',
     ...
     * Sets products
     *
     * @param  \OpenAPI\Client\Model\AutocompleteRecipeSearch200ResponseInner[]  $products  products
     * @return self
     */
    public function setProducts($products)
    {
        ...
        if ((count($products) < 0)) {
            throw new \InvalidArgumentException('invalid length for $products when calling SearchGroceryProducts200Response., number of items must be greater than or equal to 0.');
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling SearchGroceryProducts200Response., must be bigger than or equal to 1.');
        }
