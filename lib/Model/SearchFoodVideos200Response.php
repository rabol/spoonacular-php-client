...
/**
 * SearchFoodVideos200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class SearchFoodVideos200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'searchFoodVideos_200_response';
    ...
    protected static $openAPITypes = [
        'videos' => '\OpenAPI\Client\Model\SearchFoodVideos200ResponseVideosInner[]',
        'total_results' => 'int',
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['videos']) < 0)) {
            $invalidProperties[] = "invalid value for 'videos', number of items must be greater than or equal to 0.";
        }
     ...
     * Gets videos
     *
     * @return \OpenAPI\Client\Model\SearchFoodVideos200ResponseVideosInner[]
     */
     ...
     * Sets videos
     *
     * @param  \OpenAPI\Client\Model\SearchFoodVideos200ResponseVideosInner[]  $videos  videos
     * @return self
     */
    public function setVideos($videos)
    {
        ...
        if ((count($videos) < 0)) {
            throw new \InvalidArgumentException('invalid length for $videos when calling SearchFoodVideos200Response., number of items must be greater than or equal to 0.');
        }
