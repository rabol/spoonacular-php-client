...
/**
 * QuickAnswer200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class QuickAnswer200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'quickAnswer_200_response';
    ...
    public function setAnswer($answer)
    {
        ...
        if ((mb_strlen($answer) < 1)) {
            throw new \InvalidArgumentException('invalid length for $answer when calling QuickAnswer200Response., must be bigger than or equal to 1.');
        }
    ...
    public function setImage($image)
    {
        ...
        if ((mb_strlen($image) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image when calling QuickAnswer200Response., must be bigger than or equal to 1.');
        }
