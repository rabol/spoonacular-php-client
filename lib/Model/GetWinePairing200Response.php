...
/**
 * GetWinePairing200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class GetWinePairing200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getWinePairing_200_response';
    ...
    protected static $openAPITypes = [
        'paired_wines' => 'string[]',
        'pairing_text' => 'string',
        'product_matches' => '\OpenAPI\Client\Model\GetWinePairing200ResponseProductMatchesInner[]',
    ];
    ...
    public function setPairingText($pairing_text)
    {
        ...
        if ((mb_strlen($pairing_text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pairing_text when calling GetWinePairing200Response., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\GetWinePairing200ResponseProductMatchesInner[]
     */
     ...
     *
     * @param  \OpenAPI\Client\Model\GetWinePairing200ResponseProductMatchesInner[]  $product_matches  product_matches
     * @return self
     */
    public function setProductMatches($product_matches)
    {
        ...
        if ((count($product_matches) < 0)) {
            throw new \InvalidArgumentException('invalid length for $product_matches when calling GetWinePairing200Response., number of items must be greater than or equal to 0.');
        }
