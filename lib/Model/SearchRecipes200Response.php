...
/**
 * SearchRecipes200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class SearchRecipes200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'searchRecipes_200_response';
    ...
    protected static $openAPITypes = [
        'offset' => 'int',
        'number' => 'int',
        'results' => '\OpenAPI\Client\Model\SearchRecipes200ResponseResultsInner[]',
        'total_results' => 'int',
    ];
     ...
     * Gets results
     *
     * @return \OpenAPI\Client\Model\SearchRecipes200ResponseResultsInner[]
     */
     ...
     * Sets results
     *
     * @param  \OpenAPI\Client\Model\SearchRecipes200ResponseResultsInner[]  $results  results
     * @return self
     */
    public function setResults($results)
    {
        ...
        if ((count($results) < 0)) {
            throw new \InvalidArgumentException('invalid length for $results when calling SearchRecipes200Response., number of items must be greater than or equal to 0.');
        }
