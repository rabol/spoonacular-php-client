...
/**
 * SearchMenuItems200ResponseMenuItemsInner Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SearchMenuItems200ResponseMenuItemsInner implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'searchMenuItems_200_response_menuItems_inner';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SearchMenuItems200ResponseMenuItemsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setRestaurantChain($restaurant_chain)
    {
        ...
        if ((mb_strlen($restaurant_chain) < 1)) {
            throw new \InvalidArgumentException('invalid length for $restaurant_chain when calling SearchMenuItems200ResponseMenuItemsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setImage($image)
    {
        ...
        if ((mb_strlen($image) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image when calling SearchMenuItems200ResponseMenuItemsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setImageType($image_type)
    {
        ...
        if ((mb_strlen($image_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_type when calling SearchMenuItems200ResponseMenuItemsInner., must be bigger than or equal to 1.');
        }
     ...
     * Gets servings
     *
     * @return \OpenAPI\Client\Model\SearchGroceryProductsByUPC200ResponseServings|null
     */
     ...
     * Sets servings
     *
     * @param  \OpenAPI\Client\Model\SearchGroceryProductsByUPC200ResponseServings|null  $servings  servings
     * @return self
     */
