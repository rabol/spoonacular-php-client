...
/**
 * GetRandomRecipes200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class GetRandomRecipes200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getRandomRecipes_200_response';
    ...
    public function setRecipes($recipes)
    {
        ...
        if ((count($recipes) < 0)) {
            throw new \InvalidArgumentException('invalid length for $recipes when calling GetRandomRecipes200Response., number of items must be greater than or equal to 0.');
        }
