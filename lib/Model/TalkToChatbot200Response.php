...
/**
 * TalkToChatbot200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class TalkToChatbot200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'talkToChatbot_200_response';
    ...
    public function setAnswerText($answer_text)
    {
        ...
        if ((mb_strlen($answer_text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $answer_text when calling TalkToChatbot200Response., must be bigger than or equal to 1.');
        }
