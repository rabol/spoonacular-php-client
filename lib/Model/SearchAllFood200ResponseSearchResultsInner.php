...
/**
 * SearchAllFood200ResponseSearchResultsInner Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SearchAllFood200ResponseSearchResultsInner implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'searchAllFood_200_response_searchResults_inner';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SearchAllFood200ResponseSearchResultsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setResults($results)
    {
        ...
        if ((count($results) < 0)) {
            throw new \InvalidArgumentException('invalid length for $results when calling SearchAllFood200ResponseSearchResultsInner., number of items must be greater than or equal to 0.');
        }
