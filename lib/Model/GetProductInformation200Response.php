 ...
 */
class GetProductInformation200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    public function setGeneratedText($generated_text)
    {
        if (is_null($generated_text)) {
            ...
            $index = array_search('generated_text', $nullablesSetToNull, true);
            if ($index !== false) {
