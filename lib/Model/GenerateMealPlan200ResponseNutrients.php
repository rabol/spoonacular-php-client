...
/**
 * GenerateMealPlan200ResponseNutrients Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GenerateMealPlan200ResponseNutrients implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'generateMealPlan_200_response_nutrients';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('carbohydrates', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['carbohydrates'] === null) {
            $invalidProperties[] = "'carbohydrates' can't be null";
        }
    ...
    {
        return $this->container['carbohydrates'];
    }

    /**
     * Sets carbohydrates
     *
     * @param  float  $carbohydrates  carbohydrates
     * @return self
     */
    public function setCarbohydrates($carbohydrates)
    {
        if (is_null($carbohydrates)) {
            throw new \InvalidArgumentException('non-nullable carbohydrates cannot be null');
        }
        $this->container['carbohydrates'] = $carbohydrates;
