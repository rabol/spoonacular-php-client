...
/**
 * GetIngredientInformation200ResponseNutrition Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GetIngredientInformation200ResponseNutrition implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getIngredientInformation_200_response_nutrition';
    ...
    public function setNutrients($nutrients)
    {
        ...
        if ((count($nutrients) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nutrients when calling GetIngredientInformation200ResponseNutrition., number of items must be greater than or equal to 0.');
        }
    ...
    public function setProperties($properties)
    {
        ...
        if ((count($properties) < 0)) {
            throw new \InvalidArgumentException('invalid length for $properties when calling GetIngredientInformation200ResponseNutrition., number of items must be greater than or equal to 0.');
        }
