...
/**
 * AddToShoppingListRequest Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class AddToShoppingListRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'addToShoppingList_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['item']) < 1)) {
            $invalidProperties[] = "invalid value for 'item', the character length must be bigger than or equal to 1.";
        }
        ...
        if ($this->container['parse'] === null) {
            $invalidProperties[] = "'parse' can't be null";
        }
    ...
    public function setItem($item)
    {
        ...
        if ((mb_strlen($item) < 1)) {
            throw new \InvalidArgumentException('invalid length for $item when calling AddToShoppingListRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAisle($aisle)
    {
        ...
        if ((mb_strlen($aisle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $aisle when calling AddToShoppingListRequest., must be bigger than or equal to 1.');
        }
