...
/**
 * SearchCustomFoods200ResponseCustomFoodsInner Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class SearchCustomFoods200ResponseCustomFoodsInner implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'searchCustomFoods_200_response_customFoods_inner';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling SearchCustomFoods200ResponseCustomFoodsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling SearchCustomFoods200ResponseCustomFoodsInner., must be bigger than or equal to 1.');
        }
