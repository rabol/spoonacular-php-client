...
/**
 * IngredientSearch200Response Class Doc Comment
 *
 * @category Class
 *
 * @description
 ...
 */
class IngredientSearch200Response implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ingredientSearch_200_response';
    ...
    protected static $openAPITypes = [
        'results' => '\OpenAPI\Client\Model\IngredientSearch200ResponseResultsInner[]',
        'offset' => 'int',
        'number' => 'int',
        'total_results' => 'int',
    ];
     ...
     * Gets results
     *
     * @return \OpenAPI\Client\Model\IngredientSearch200ResponseResultsInner[]
     */
     ...
     * Sets results
     *
     * @param  \OpenAPI\Client\Model\IngredientSearch200ResponseResultsInner[]  $results  results
     * @return self
     */
    public function setResults($results)
    {
        ...
        if ((count($results) < 0)) {
            throw new \InvalidArgumentException('invalid length for $results when calling IngredientSearch200Response., number of items must be greater than or equal to 0.');
        }
