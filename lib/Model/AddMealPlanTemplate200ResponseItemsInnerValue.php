...
/**
 * AddMealPlanTemplate200ResponseItemsInnerValue Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class AddMealPlanTemplate200ResponseItemsInnerValue implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'addMealPlanTemplate_200_response_items_inner_value';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling AddMealPlanTemplate200ResponseItemsInnerValue., must be bigger than or equal to 1.');
        }
    ...
    public function setImageType($image_type)
    {
        ...
        if ((mb_strlen($image_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_type when calling AddMealPlanTemplate200ResponseItemsInnerValue., must be bigger than or equal to 1.');
        }
