...
class DefaultApi
{
    ...
    {
        [$response] = $this->analyzeRecipeWithHttpInfo($analyze_recipe_request, $language, $include_nutrition, $include_taste, $contentType);
    ...
    {
        [$response] = $this->createRecipeCardGetWithHttpInfo($id, $mask, $background_image, $background_color, $font_color, $contentType);
    ...
    {
        [$response] = $this->searchRestaurantsWithHttpInfo($query, $lat, $lng, $distance, $budget, $cuisine, $min_rating, $is_open, $sort, $page, $contentType);
