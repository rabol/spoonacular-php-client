...
class WineApi
{
    ...
    {
        [$response] = $this->getDishPairingForWineWithHttpInfo($wine, $contentType);
    ...
    {
        [$response] = $this->getWineDescriptionWithHttpInfo($wine, $contentType);
    ...
    {
        [$response] = $this->getWinePairingWithHttpInfo($food, $max_price, $contentType);
    ...
    {
        [$response] = $this->getWineRecommendationWithHttpInfo($wine, $max_price, $min_rating, $number, $contentType);
